    ...
    icon: (
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          <g>
            <g>
              <path d="M329.2,327.2c-4.5,0-8.1,3.4-8.6,7.9c-3.9,38.6-36.5,68.7-76.2,68.7c-39.6,0-72.2-30.1-76.2-68.7 c-0.5-4.4-4.1-7.9-8.6-7.9h-104c-21.8,0-39.5,17.7-39.5,39.5v82.8c0,21.8,17.7,39.5,39.5,39.5h377.8c21.8,0,39.5-17.7,39.5-39.5 v-82.7c0-21.8-17.7-39.5-39.5-39.5H329.2V327.2z"></path>
              <path d="M303.5,198.6l-30.9,30.9V28.1C272.6,12.6,260,0,244.5,0l0,0c-15.5,0-28.1,12.6-28.1,28.1v201.4l-30.9-30.9 c-9.5-9.5-24.7-11.9-35.9-4.4c-15.3,10.2-16.8,31.1-4.5,43.4l82.8,82.8c9.2,9.2,24.1,9.2,33.3,0l82.8-82.8 c12.3-12.3,10.8-33.2-4.5-43.4C328.2,186.6,313,189,303.5,198.6z"></path>
            </g>
          </g>
        </g>
      </svg>
    ...
    icon: (
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <path d="M19.071,4.929a10,10,0,1,0,0,14.142L12,12ZM10,9a2,2,0,1,1,2-2A2,2,0,0,1,10,9Z"></path>
        </g>
      </svg>
    ),
  },
...
export function Browse() {
  return (
    <SidebarGroup>
      <SidebarGroupLabel className="text-2xl font-medium mb-2">
        Browse
      </SidebarGroupLabel>
      <SidebarGroupContent>
        <SidebarMenu>
